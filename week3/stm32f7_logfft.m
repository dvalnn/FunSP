% STM32F7_LOGFFT.M
% 
% MATLAB function to read (sample) values saved from STM32F7
...
set(gcf,'name','data read from STM32F7 memory in Keil uVision 5 - freq domain')
...
figure(2)
set(gcf,'numberTitle','off')
set(gcf,'name','data read from STM32F7 memory in Keil uVision 5 - time domain')
